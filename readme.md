...
PhpRedis extension pre-complied binary DLL for windows. PHP 8.0 / 8.1 / 8.2 / 8.3 / 8.4 / 8.5 / 8.6 + PhpRedis 6.2 / 6.3 is Ready.
...
|:-:|:-:|:-|
| 8.6 | / | [PhpRedis 6.3.0 + PHP 8.6.0 beta](https://github.com/dk-sirk/phpredis-windows-release/releases/tag/php_redis-6.3.0-php-8.6.0b1) |
| 8.5 | [pecl](https://pecl.php.net/package/redis/6.3.0/windows) | [PhpRedis 6.3.0 + PHP 8.5](https://github.com/dk-sirk/phpredis-windows-release/releases/tag/php_redis-6.3.0-php-8.5.0)<br>[PhpRedis 6.3.0 + PHP 8.5.0 rc](https://github.com/dk-sirk/phpredis-windows-release/releases/tag/php_redis-6.3.0-php-8.5.0rc4)<br>[PhpRedis 6.3.0 rc + PHP 8.5.0 rc](https://github.com/dk-sirk/phpredis-windows-release/releases/tag/php_redis-6.3.0rc1-php-8.5.0rc3) |
...
|PHP| PECL | THIS PROJECT |
|:-:|:-:|:-|
| 8.5 | / | [PhpRedis 6.1.0 + PHP 8.5](https://github.com/dk-sirk/phpredis-windows-release/releases/tag/php_redis-6.1.0-php-8.5.0) |
